...
import { FileCategoryModelSchema } from "#generated/zod/schemas/index.js";
 ...
 */
export const CreateFileCategoryRequestSchema = z
	.object({
 ...
 */
export type CreateFileCategoryRequest = z.infer<
	typeof CreateFileCategoryRequestSchema
>;
 ...
 */
export type CreateFileCategoryResponse = z.infer<
	typeof CreateFileCategoryResponseSchema
>;
