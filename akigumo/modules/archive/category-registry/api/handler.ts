...
import { translatePrismaError } from "#akigumo/shared/utils/index.js";

import { categoryRegistryRoute } from "./route.js";
 ...
 */
export const handleCategoryRegistry = app.openapi(
	categoryRegistryRoute,
	async (c) => {
