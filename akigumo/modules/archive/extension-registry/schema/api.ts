...
import { FileExtensionModelSchema } from "#generated/zod/schemas/index.js";
 ...
 */
export const CreateFileExtensionRequestSchema = z
	.object({
	...
	.refine(
		(data) =>
			data.categoryId !== undefined || data.categoryCode !== undefined,
		{
			message: "必須提供 categoryId 或 categoryCode 其中一個",
			path: ["categoryId"],
		},
	)
 ...
 */
export type CreateFileExtensionRequest = z.infer<
	typeof CreateFileExtensionRequestSchema
>;
 ...
 */
export type CreateFileExtensionResponse = z.infer<
	typeof CreateFileExtensionResponseSchema
>;
